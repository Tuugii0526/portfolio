export const ThemeSum=({handleTheme,hiddenOfTheme})=>{
    return <svg onClick={handleTheme} width="36" height="36" className={`${hiddenOfTheme} min-[990px]:block dark:text-[#D1D5DB]`} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
